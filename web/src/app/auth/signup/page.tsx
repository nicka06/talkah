        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white border-2 border-black rounded-2xl shadow-xl p-6 sm:p-8 text-black">
            ...
            <div className="flex items-center my-6">
              ...
              <span className="mx-4 text-black/70 font-semibold text-sm sm:text-base">or</span>
              <div className="flex-grow border-t border-black" />
            </div>
            <div className="space-y-3">
              <button onClick={() => handleOAuth('google')} className="w-full flex items-center justify-center border-2 border-black text-black font-semibold py-3 sm:py-2 rounded-lg hover:bg-black hover:text-white transition-colors touch-manipulation">
              ...
              <button onClick={() => handleOAuth('apple')} className="w-full flex items-center justify-center border-2 border-black text-black font-semibold py-3 sm:py-2 rounded-lg hover:bg-black hover:text-white transition-colors touch-manipulation">
                ...
                <span className="text-sm sm:text-base">Sign up with Apple</span>
              </button>
            </div>
          </div>
        </div>
